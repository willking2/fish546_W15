...
Output file here: [`Nlap_uniprot_blastx2.tab`](https://github.com/willking2/fish546_W15/blob/master/nlap-ano/data/Nlap_uniprot_blastx2.tab)

### Upload blastx output to SQLShare

	SELECT * FROM [wking2@washington.edu].[table_Nlap_uniprot_blastx2_4.tab]

![screenshott](https://github.com/willking2/fish546_W15/blob/master/nlap-ano/img/Capture.PNG)
...
Open [`Nlap_annotated_GO.csv`](./products/Nlap_annotated_GO.csv) in Excel.
...
Do this by making a separate three column table for each aspect: F, C, or P. Aspects are in the last column of the [`Nlap_annotated_GO.csv`](./products/Nlap_annotated_GO.csv) file. Use Excel's sorting fuction. 
...
Excel file here: [`Nlap_GO_plot.xlsx`](https://github.com/willking2/fish546_W15/blob/master/nlap-ano/analyses/Nlap_GO_plot.xlsx)
